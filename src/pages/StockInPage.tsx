...
import { stockIn } from '../services/stock.api';
import type { StockInRequest } from '../services/stock.api';
...
export default function StockInPage() {
  ...
  // Note: Backend handles lot logic, frontend sends barcode + quantity only
